    ...
    try {
      ...
      res.status(200).json({ code: CU_CREATED, callback: customer });
        ...
        if (error.message === 'Username vide ou invalide') {
            ...
            errorMessage = 'Username vide ou invalide';
...
exports.update = async (req, res) => {
    try {
      ...
      res.status(200).json({ code: CU_UPDATED, callback: 'Client modifié avec succès' });
      ...
      if (error.message === 'Vous n\'etes pas un client') {
        ...
        errorMessage = 'Vous n\'etes pas un client';
...
exports.delete = async (req, res) => {
    try {
      ...
      res.status(200).json({ code: CU_DELETED, callback: 'Customer supprimé avec succès' });
...
exports.forgetPassword = async (req, res) => {
    try {
      ...
      if (error.message === 'Email ou nouveau mot de passe invalide') {
        ...
        errorMessage = 'Email ou nouveau mot de passe invalide';
